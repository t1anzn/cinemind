...
export default function Pagination({ currentPage, totalPages, onPageChange }) {
    ...
    const getPageNumbers = () => {
        ...
        if (start > 2) {
            ...
            pageNumbers.push(
                <span key="ellipsis-start" className="w-10 h-10 text-white text-center flex items-center justify-center">...</span>
            );
        }
        ...
        if (end < totalPages - 1) {
            pageNumbers.push(
                <span key="ellipsis-end" className="w-10 h-10 text-white text-center flex items-center justify-center">...</span>
            );
            pageNumbers.push(
                <button
                    key="end"
